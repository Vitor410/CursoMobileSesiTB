...
class _LoginViewState extends State<LoginView> {
  ...
  final _authController = FirebaseAuth
      .instance; //controller para manipulaçao do Usuário no Firebaseauth
  ...
  void _login() async{
    try {
      ...
      //não precisa do Navigator, pois usaremos o StreamBuilder
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                suffix: IconButton(
                  onPressed: ()=>setState(() {
                    _senhaOculta = !_senhaOculta; //inverte o valor de variavel para boolean
                  }), 
